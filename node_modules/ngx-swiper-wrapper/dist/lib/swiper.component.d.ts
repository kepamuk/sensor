import { AfterViewInit, OnDestroy, EventEmitter, NgZone, Renderer2, ElementRef } from '@angular/core';
...
export declare class SwiperComponent implements AfterViewInit, OnDestroy {
    ...
    constructor(platformId: Object, zone: NgZone, renderer: Renderer2, elementRef: ElementRef, defaults: SwiperConfigInterface);
